...
export default class Servicios extends Component {
    ...
    render() {
        return (
                <div className="fondo-servicios" id="servicios">
                    <div className="container">
                        <div className="row">
                            <div className="col-12" >
                                <h3 className="text-center titulo-servicios font-weight-bold" id="servicios">Servicios</h3>
                            </div>
                            <div className="col-12">
                                <h5 className="text-center subtitulo-servicios">Hacemos que todos tus sueños se conviertan en estas realidades</h5>
                            </div>
                            <div className="col-12">
                            ...
                            {this.contenidos.map((contenido, key) => {
                                return (
                                    <div className=" col-sm-12 col-md-6 col-lg-3 flex-column" key={key}>
                                        <div className="fondo-img d-flex justify-content-center">
                                        ...
                                        <div className="d-flex flex-column justify-content-center">
                                            ...
                                            <h6 className="text-center subtitulo-servicio ">{contenido.descripcion}</h6>
                                        </div>
                                        <hr className="linea" />
                                    </div>
                                )
