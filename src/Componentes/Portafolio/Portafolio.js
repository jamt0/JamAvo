...
export default class Portafolio extends Component {
    ...
    contenidos=[
        {titulo:"Todo", id:"tab-todo", href:"#todo", controls:"todo", class:"nav-link active", select:"true", class2:"tab-pane fade show active"},
        {titulo:"Páginas web", id:"tab-web", href:"#web", controls:"web", class:"nav-link", select:"false", class2:"tab-pane fade"},
    ...
    render() {
        return (
            <div className="fondo-portafolio" style={{ paddingTop: 20, marginBottom: 20 }} id="portafolio">
